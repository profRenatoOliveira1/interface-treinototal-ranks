...
function CadastroProfessor() {
    ...
    const [formData, setFormData] = useState({
        ...
        dataNascimento: '',       // Campo para a data de nascimento
        celular: '',             // Campo para o número de celular
        endereco: '',            // Campo para o endereço
        email: '',               // Campo para o email
        senha: '',               // Campo para a senha
        dataContratacao: '',     // Campo para a data de contratação
        formacao: '',            // Campo para a formação acadêmica
