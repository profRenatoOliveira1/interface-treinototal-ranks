                                    ...
                                    <div className="card-back">
                                        <div className="center-wrap">
                                            <div className=" text-center ajuste-tamanho">
                                                <h2 className="mb-3 pb-3">Cadastro de professor</h2>
                                                <div className="form-group ">
                                                    <input type="text" className="form-style" placeholder="Nome " />
                                                ...
                                                <div className="form-group mt-2">
                                                    <input type="password" className="form-style senha" placeholder="Senha" />
                                                ...
                                                <div className="form-group mt-2">
                                                    <input type="text" className="form-style" placeholder="Formação" />
                                                    <i className="input-icon uil uil-at"></i>
                                                </div>
                                                <div className="form-group mt-2">
