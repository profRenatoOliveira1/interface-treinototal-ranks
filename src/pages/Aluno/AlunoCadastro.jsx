...
// Importa o componente CadastroAluno, que está localizado na pasta '../../components/Cadastro/CadastroAluno'.
...
function AlunoCadastro() {
    ...
    return (
        <> {/* Fragmento React para envolver múltiplos elementos */}
            ...
            <CadastroAluno /> {/* Renderiza o componente de cadastro de aparelhos */}
        </>
    );
}
