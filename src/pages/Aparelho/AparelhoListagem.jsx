...
import ListagemAparelho from '../../components/Listagem/ListagemAparelho';
// Importa o componente ListagemAparelho, que está localizado na pasta '../../components/Listagem/ListagemAparelho'.
...
function AparelhoListagem() {
    ...
    return (
        <> {/* Fragmento React para envolver múltiplos elementos */}
            ...
            <ListagemAparelho /> {/* Renderiza o componente de listagem de aparelhos */}
        </>
    );
}
